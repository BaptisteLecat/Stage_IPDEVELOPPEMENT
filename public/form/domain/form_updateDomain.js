function updateDomain_modal() {
    ...
    xhr.send("view=form&form=updateDomain&idDomain=" + encodeURI(idDomain) + "&idClient=" + encodeURI(idClient) + "&controller=" + encodeURI(controller));
}