...
class DNS_Record_MX extends DNS_Record implements JsonSerializable
{
    private $priority;

    function __construct(int $id, string $subDomain, string $target, $deleted_on, $created_on, $modified_on, $domainObject, $DNS_FieldObject, $priority)
    {
